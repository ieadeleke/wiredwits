            ...
            <Drawer open={openMenu} onClose={toggleDrawer} footer={null}>
                <div>
                    ...
                    <ul className="flex flex-col gap-4">
                        ...
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                            <Link href="/about" className="text-sm font-medium p-4">
                                About Us</Link>
                        </li>
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                        ...
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                            <Link href="/public-good" className="text-sm font-medium p-4">
                                Public Good</Link>
                        </li>
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                            <Link href="/business-empowerment" className="text-sm font-medium p-4">
                                Business Empowerment</Link>
                        </li>
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                            <Link href="/everyday-ai" className="text-sm font-medium p-4">
                                Everyday AI</Link>
                        </li>
                        <li className="border-b border-solid border-[#F5F3FF] pb-4 text-black">
                            <Link href="/contact-us" className="text-sm font-medium p-4">
                                Contact Us</Link>
                        </li>
                        {
                            user?.first_name ? ''
