                    ...
                    <section className="hero-bg flex items-center justify-center text-center">
                        <div className="md:w-[90%] mx-auto gap-20 py-32 md:pt-36 pb-16">
                            <div className="px-5 md:px-0 md:w-[70%] mx-auto">
                                ...
                                <h1 className="text-3xl md:text-5xl font-bold mb-2 md:mb-4 mx-auto leading-relaxed md:leading-tight">
                        ...
                        <div className="grid grid-cols-2 gap-20 mb-32">
                            <div>
                                <div className="">
                                    ...
                                    <h3 className="text- text-4xl mb-2 font-bold leading-snug md:leading-snug">
                                        Truth isn&apos;t optional
                                    </h3>
                                </div>
                                <div className="">
                                    <p className="text-base mx-auto leading-loose md:leading-loose font-mediu opacity-80 mb-14">
                        ...
                        <div className="grid grid-cols-2 gap-20 mb-32">
                            ...
                            <div>
                                <div className="">
                                    ...
                                    <h3 className="text- text-4xl mb-2 font-bold leading-snug md:leading-snug w-[70%]">
